...
const sortLabel:Record<SortKey,string>={evaluation_recent:"آخرین ارزیابی → اولین",evaluation_due:"اولین/قدیمی‌ترین → آخرین",score_desc:"بالاترین امتیاز → کمترین",stars_desc:"بیشترین ستاره → کمترین"};
