...
@media(max-width:759px){
 ...
 .cb4-mobile-banner img{display:block;object-fit:cover;position:relative;z-index:2;background:transparent}
 .cb4-benefits-wrap .cb3-head{display:none!important}
}
`}</style><section className="cb4-mobile-banner" aria-label="پاداش و مزایای مراقبین سلامت اول"><div className="cb4-mobile-banner-fallback" aria-hidden="true"><strong>پاداش و مزایای متنوع</strong><span>برای رفاه حال مراقبین سلامت اول</span></div><img src="/mobile/caregiver-benefits-banner-v1.webp?v=5" alt="پاداش و مزایای متنوع برای رفاه حال مراقبین سلامت اول" loading="eager" decoding="sync" onError={event=>{const img=event.currentTarget;if(img.dataset.fallback!=="1"){img.dataset.fallback="1";img.src="/assets/caregiver-benefits-banner-v1.webp?v=5"}else{img.style.display="none"}}}/></section><BenefitsPageV3/><div className="cb4-loan-preview"><CaregiverLoanAccreditationPreviewV1/></div><div className="cb4-referral-v6"><ReferralBenefitsV6/></div><div className="cb4-request-center"><CaregiverRequestsV1/></div></div>}
