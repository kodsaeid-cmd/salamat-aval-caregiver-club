...
@media(max-width:759px){
 .cb4-mobile-banner{display:grid;margin:0 0 12px;overflow:hidden;border-radius:18px;background:linear-gradient(135deg,#f8fcfa,#edf7f1);box-shadow:0 8px 24px rgba(20,66,44,.08);aspect-ratio:5/2;position:relative}
 ...
 .cb4-mobile-banner img{display:block;object-fit:cover;image-rendering:auto;position:relative;z-index:2;background:transparent;transform:translateZ(0)}
 .cb4-benefits-wrap .cb3-head{display:none!important}
}
`}</style><section className="cb4-mobile-banner" aria-label="پاداش و مزایای مراقبین سلامت اول"><div className="cb4-mobile-banner-fallback" aria-hidden="true"><strong>پاداش و مزایای متنوع</strong><span>برای رفاه حال مراقبین سلامت اول</span></div><img src="/mobile/caregiver-benefits-banner-v2.webp?v=12" width={1600} height={640} alt="پاداش و مزایای متنوع برای رفاه حال مراقبین سلامت اول" loading="eager" fetchPriority="high" decoding="async" onError={event=>{const img=event.currentTarget;if(img.dataset.fallback!=="1"){img.dataset.fallback="1";img.src="/assets/caregiver-benefits-banner-v2.webp?v=12"}else{img.style.display="none"}}}/></section><BenefitsPageV3/><div className="cb4-loan-preview"><CaregiverLoanAccreditationPreviewV1/></div><div className="cb4-referral-v6"><ReferralBenefitsV6/></div><div className="cb4-request-center"><CaregiverRequestsV1/></div></div>}
