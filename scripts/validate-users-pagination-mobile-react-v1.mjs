...
must(directory.includes('url.searchParams.get("sort")')&&directory.includes('ORDER BY u.created_at ${direction}')&&directory.includes('createdFrom')&&directory.includes('createdTo')&&directory.includes('roleFilter'),'users API must apply global created-date sorting plus role/date filters before pagination');
...
console.log('Desktop 50-row pagination + desktop/mobile sorting/filtering + mobile React routing validation passed');
