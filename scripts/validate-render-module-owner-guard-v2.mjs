...
for(const value of ["CONTRACT_OWNER='2.0.0'","'/mobile/admin/job_ads'","'/mobile/admin/caregivers'","'/mobile/admin/financial_credits'",'/mobile/scorecard?prelaunch=',"['پشتیبانی و امنیت','/app/support','پشتیبانی','پشتیبانی']",'errors.length===0'])has(browser,value,`browser smoke v2 missing ${value}`);
