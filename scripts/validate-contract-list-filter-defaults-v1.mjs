...
expect(source.includes('x-salamat-contract-list-source')&&source.includes('multi-period-v3-jalali'), 'production response does not expose the V3/Jalali repaired list source marker');
...
console.log('Contract list default numeric filters remain unset; V3/Jalali list repair cannot silently add <= 0 constraints.');
