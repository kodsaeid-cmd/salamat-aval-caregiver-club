...
const checks=[
  ...
  ['panel waits for a canonical staff surface', panel.includes('canonicalStaffSurfaceReady')&&panel.includes(".spx-dashboard")&&panel.includes("staff.dashboard")],
  ...
  ['worker cache-busts panel runtime v1.2.0', worker.includes('PANEL_ROUTE_VERSION = "1.2.0"')],
];
