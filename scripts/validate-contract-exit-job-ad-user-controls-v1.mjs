...
expect(entry.indexOf('routeProductionContractRepairV1')<entry.indexOf('routeStaffContractReopenV1'), 'production-safe contract route does not own contract-exit before the legacy handler');
...
expect(contractsOwner.includes('./contracts-lifecycle-v5'), 'contract lifecycle v5 is not the active desktop owner');
