...
for(const value of ['import app from "./index-unified-financial-v4"','MOBILE_BASELINE_ASSET = "mobile-responsive-runtime.js"','MOBILE_BASELINE_VERSION = "1.1.1"','stripAllLaterMobileScripts','x-salamat-mobile-layer-count','x-salamat-mobile-owner'])has(resetEntry,value,`mobile reset wrapper must preserve unified finance ownership: ${value}`);
