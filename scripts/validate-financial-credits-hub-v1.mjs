...
const flatEntry=read('worker/index-mobile-flat-v8-3.ts');
...
has(wrangler,'"main": "./worker/index-mobile-flat-v8-3.ts"','production entrypoint must activate the flat mobile presentation wrapper');
for(const value of ['import app from "./index-unified-financial-v4"','MOBILE_FLAT_DASHBOARD_VERSION = "8.3.0"','MOBILE_FLAT_DASHBOARD_ASSET = "mobile-flat-dashboard-v8-3.js"','x-salamat-mobile-flat-dashboard'])has(flatEntry,value,`flat dashboard wrapper must preserve unified finance ownership: ${value}`);
...
console.log('Financial credits hub single-owner v9 contract passed: unified finance remains canonical under the V8.3 flat mobile presentation wrapper.');
