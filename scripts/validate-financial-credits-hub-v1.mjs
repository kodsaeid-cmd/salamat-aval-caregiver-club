...
console.log('Financial credits hub single-owner v9 contract passed: the legacy caregiver finance renderer is inert and stripped from final HTML, so only the canonical financial profile can own the wallet DOM.');
