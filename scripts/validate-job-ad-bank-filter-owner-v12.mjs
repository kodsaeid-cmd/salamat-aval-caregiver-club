...
expect(route.includes('a.deleted_at IS NULL')||route.includes("a.status<>'DELETED'"),'new direct list route can expose soft-deleted ads');
...
console.log('Exact GET /api/staff/job-ads is owned by the filter/sort route before the legacy staff-read wrapper and excludes soft-deleted ads.');
