...
const HISTORY_TAG = `<script src="./internal-history-runtime.js?v=${HISTORY_VERSION}"></script>`;
...
function addResourceHints(html: string) {
  ...
  const hints = [
    '<meta name="salamat-build" content="performance-2.2.0">',
...
function optimizeHtml(source: string) {
  ...
  html = replaceVersion(html, "internal-history-runtime.js", HISTORY_VERSION);
  ...
  if (!html.includes("internal-history-runtime.js")) {
